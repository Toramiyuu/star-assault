...
- [ ] **Phase 1: HUD Foundations + XP Orb Clarity** - Orange XP orbs replace invisible green ones; stat bar removed from live HUD; HUD fill bars switch to scaleX tween with dirty-flag guard
